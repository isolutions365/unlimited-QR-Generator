...
// Allowed acronyms/brand names to keep intact in English uppercase
...
console.log("Direct translations count:", Object.keys(directTranslations).length);
