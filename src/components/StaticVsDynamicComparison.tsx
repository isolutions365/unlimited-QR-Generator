...
export const StaticVsDynamicComparison: React.FC<StaticVsDynamicComparisonProps> = ({
  ...
  const comparisonFeatures = [
    {
      feature: t('compare.pricingLabel', 'Pricing & Commercial Usage'),
      description: t('compare.pricingDesc', 'Cost to generate, download vector assets, and deploy'),
      staticVal: t('compare.staticPricing', 'Free Client-Side Generation'),
      staticSub: t('compare.staticPricingSub', 'Unlimited offline matrix generation, vector exports, and direct scans'),
      staticBadge: 'positive',
      dynamicVal: t('compare.dynamicPricing', 'Free Platform Dynamic Tier'),
      dynamicSub: t('compare.dynamicPricingSub', 'Dynamic redirection and scan metrics available with zero upfront paywall'),
      dynamicBadge: 'positive'
    },
    {
      feature: t('compare.signupLabel', 'Account & Registration Requirement'),
      description: t('compare.signupDesc', 'Whether registration is required before generating or downloading'),
      staticVal: t('compare.staticSignup', 'No Account Required'),
      staticSub: t('compare.staticSignupSub', 'Generate and download PNG, SVG, or PDF instantly in browser'),
      staticBadge: 'positive',
      dynamicVal: t('compare.dynamicSignup', 'Optional Account for Management'),
      dynamicSub: t('compare.dynamicSignupSub', 'Preview instantly; connect account to manage live redirect targets & dashboard'),
      dynamicBadge: 'neutral'
    },
    {
      feature: t('compare.expirationLabel', 'Lifespan & Infrastructure Dependency'),
      ...
      staticSub: t('compare.staticExpirationSub', 'Self-contained 2D matrix. Web destinations remain subject to target website uptime.'),
      staticBadge: 'positive',
      dynamicVal: t('compare.dynamicExpiration', 'Dependent on Redirect Server'),
      dynamicSub: t('compare.dynamicExpirationSub', 'Scans resolve via intermediate cloud endpoint; active as long as redirect service is maintained'),
      dynamicBadge: 'neutral'
    },
    {
      feature: t('compare.analyticsLabel', 'Scan Telemetry & Attribution'),
      description: t('compare.analyticsDesc', 'Ability to record scan volume, device OS, and timestamps'),
      staticVal: t('compare.staticAnalytics', 'No Intermediary Redirect Logs'),
      staticSub: t('compare.staticAnalyticsSub', 'Scanner connects directly to target. (Target website or scanner app may log independently)'),
      staticBadge: 'neutral',
      dynamicVal: t('compare.dynamicAnalytics', 'Server-Side Scan Telemetry'),
      dynamicSub: t('compare.dynamicAnalyticsSub', 'Records scan counts, timestamps, inferred device OS from User-Agent, and IP-derived coarse location'),
      dynamicBadge: 'positive'
    },
    {
      ...
      staticVal: t('compare.staticEditing', 'Hardcoded in Matrix'),
      staticSub: t('compare.staticEditingSub', 'Payload is physically fixed. Updating destination requires reprinting or host-level 301 redirect on target domain.'),
      staticBadge: 'negative',
      dynamicVal: t('compare.dynamicEditing', 'Editable via Management Dashboard'),
      dynamicSub: t('compare.dynamicEditingSub', 'Update destination URL anytime without altering printed QR matrix'),
      dynamicBadge: 'positive'
    },
    {
      feature: t('compare.privacyLabel', 'Resolution Workflow & Dependencies'),
      description: t('compare.privacyDesc', 'How payload is decoded and resolved by scanning devices'),
      staticVal: t('compare.staticPrivacy', 'Local Matrix Decoding'),
      staticSub: t('compare.staticPrivacySub', 'Matrix decodes locally on device; opening web links connects directly to destination host'),
      staticBadge: 'positive',
      dynamicVal: t('compare.dynamicPrivacy', 'Intermediary Cloud Forwarding'),
      dynamicSub: t('compare.dynamicPrivacySub', 'Device contacts redirect server (via HTTP 302/307) which logs metrics and forwards to destination'),
      dynamicBadge: 'neutral'
    },
  ];
