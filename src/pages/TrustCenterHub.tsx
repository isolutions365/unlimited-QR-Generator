...
export const trustPages: TrustPageContent[] = [
  ...
  },
  {
    ...
    readingTime: '3 min read',
    aiSummary: {
      gemini: 'The FreeQRBarcodes visual identity reflects our focus on developer-first simplicity and optical speed. It features Indigo-600 as our primary color, balanced by deep slate tones and spacious, high-contrast layouts.',
      ...
      perplexity: 'FreeQRBarcodes utilizes "Inter" for UI and "Space Grotesk" for display typography, creating a clean, tech-forward aesthetic. We provide these details to help developers maintain a consistent look across their integrations.'
    },
    citationBlock: {
              ...
              <nav className="hidden lg:flex flex-col gap-1 max-h-[640px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-slate-200 scrollbar-track-transparent">
                {trustPages.map(page => {
                  ...
                  return (
                    <a
                      key={page.slug}
                      href={page.slug === 'privacy' ? '/privacy-policy' : `/${page.slug}`}
                      onClick={(e) => {
                        e.preventDefault();
                        handleNav(page.slug);
                      }}
