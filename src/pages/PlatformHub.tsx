...
import { 
  ...
  Key, History, Sliders, ChevronDown, CheckCircle, Home
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50/50 text-slate-800 font-sans">
      ...
      <div className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-xs">
        <ScrollableTabContainer
          ...
          innerClassName="flex items-center gap-2 py-3"
        >
          <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider pr-2 border-r border-slate-200 shrink-0">
          ...
          {platformModules.map(m => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap cursor-pointer flex items-center gap-1.5 transition-all shrink-0 ${
                  isActive 
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <ScrollableTabContainer
          className="border-b border-slate-200 mb-8"
          gradientColor="from-white"
          innerClassName="flex items-center"
        >
          <button
            onClick={() => setActiveTab('landing')}
            className={`py-3 px-4 text-xs font-bold border-b-2 whitespace-nowrap cursor-pointer transition-colors shrink-0 ${
